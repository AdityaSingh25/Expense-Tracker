...
import React from "react"; // use state is a function provided by the react library
...
const ExpenseItem = (props) => {
  ...
  // //one thingh here is we are using const here. but we are eventually changing the value. how does that work?. this works bcz we are not assigning the value with the equal sign(=). we are changing the value with a function provided by the useState
